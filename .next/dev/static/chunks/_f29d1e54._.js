...
function HousekeepingAudit({ categories, setCategories }) {
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HousekeepingAudit.useMemo[stats]": ()=>{
            const allItems = filteredCategories.flatMap({
                "HousekeepingAudit.useMemo[stats].allItems": (cat)=>cat.items
            }["HousekeepingAudit.useMemo[stats].allItems"]);
            return {
                total: allItems.length,
                checked: allItems.filter({
