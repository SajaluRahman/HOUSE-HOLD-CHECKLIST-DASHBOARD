...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/zustand/esm/react.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/zustand/esm/middleware.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/api/index.ts [app-client] (ecmascript)"); // adjust path to your api file
;
;
;
...
const useStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["devtools"])((set)=>({
        ...
        fetchCategories: async ()=>{
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRequest"])("/category/get-cound", withAuth());
            if (!res.error) {
                set({
        ...
        createCategory: async (data)=>{
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postRequest"])({
        ...
        updateCategory: async (id, data)=>{
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["patchRequest"])({
        ...
        deleteCategory: async (id)=>{
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteRequest"])(`/category/delet/${id}`, withAuth());
            if (!res.error) {
                set((state)=>({
        ...
        fetchDailyAreas: async ()=>{
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRequest"])("/task/getall", withAuth());
            if (!res.error) {
                set({
        ...
        fetchCategorySummary: async ()=>{
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRequest"])("/task/coundsummary", withAuth());
            if (!res.error) {
                set({
        ...
        fetchObservations: async ()=>{
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRequest"])("/observation/getall-observations", withAuth());
            if (!res.error) {
                set({
        ...
        updateObservation: async (id, data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["putRequest"])({
        ...
        deleteObservation: async (id)=>{
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteRequest"])(`/observation/delete-observations/${id}`, withAuth());
            if (!res.error) {
                set((state)=>({
...
function HousekeepingAudit() {
            ...
            return categories.map({
                "HousekeepingAudit.useMemo[transformedCategories]": (cat)=>{
                    const items = dailyAreas.filter({
                        "HousekeepingAudit.useMemo[transformedCategories].items": (area)=>typeof area.category === 'string' ? area.category === cat._id : area.category?._id === cat._id
                    }["HousekeepingAudit.useMemo[transformedCategories].items"]).map({
                        "HousekeepingAudit.useMemo[transformedCategories].items": (area)=>mapDailyAreaToAuditItem(area, cat._id, cat.name)
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HousekeepingAudit.useMemo[stats]": ()=>{
            ...
            return {
                total: all.length,
                checked: all.filter({
                    "HousekeepingAudit.useMemo[stats]": (i)=>i.status === "done" || i.status === "checked"
    ...
    const handleToggleStatus = async (categoryId, itemId, newStatus)=>{
        // Optimistic update
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].setState((state)=>({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            transformedCategories.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HousekeepingAudit, "MJ677mFOKm7SxuxbfwoBYOMcZPQ=", false, function() {
    return [
...
//# sourceMappingURL=_371389d0._.js.map