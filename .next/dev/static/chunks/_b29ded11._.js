...
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAdminStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/useAdminStore.ts [app-client] (ecmascript)"); // <== your Zustand store path
...
function LoginPage() {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAdminStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminStore"])({
        "LoginPage.useAdminStore[login]": (state)=>state.login
    }["LoginPage.useAdminStore[login]"]);
    const loadingGlobal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAdminStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminStore"])({
        "LoginPage.useAdminStore[loadingGlobal]": (state)=>state.loading
    }["LoginPage.useAdminStore[loadingGlobal]"]);
...
_s(LoginPage, "s8fHraGkckXk8Wk0zORcXEXJa2o=", false, function() {
    return [
...
//# sourceMappingURL=_b29ded11._.js.map